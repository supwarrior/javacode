...
public class SimpleSkipListMap<K, V> extends AbstractMap<K, V> implements Cloneable, Serializable {
    ...
    /**
     * 节点类，注意两点：1.value为null时，表示此节点已经删除；
     * 2.value的类型为Object是因为一些特殊情况它不为V类型，例如BASE_HEADER
     */
